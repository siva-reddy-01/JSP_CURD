...
try
{
	 ...
	 System.out.println("Connection Established");
	  ...
	  PreparedStatement pstmt = con.prepareStatement("select * from userreg where email=? and pwd=?");
	  pstmt.setString(1,email);
	  pstmt.setString(2,opwd);
	  ResultSet rs = pstmt.executeQuery();
	  if(rs.next())
	  {
		  PreparedStatement pstmt1 = con.prepareStatement("update userreg set pwd=? where email=?");
